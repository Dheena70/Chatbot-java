...
public class AiClient {
    ...
    public String ask(String userMessage, List<Turn> history) throws IOException, InterruptedException {
        ...
        String systemInstruction = "{\"parts\":[{\"text\":\"You are DevBot (JARVIS), an advanced autonomous Jarvis-like Personal AI Assistant with real control over the user's Windows laptop, created by Dheena. "
                ...
                + "CRITICAL BROWSER RULE: NEVER open the browser or search Google/YouTube when the user asks to open an app, software, game, or tool! If the user says 'open antigravity', 'open antigravity ide', 'unna open pannu', or 'open yourself', you MUST use [ACTION:open_app:antigravity] to launch the local Antigravity application directly! NEVER redirect app opening commands to the browser!\\n"
