...
public class AiClient {
    ...
    public String ask(String userMessage, List<Turn> history) throws IOException, InterruptedException {
        ...
        String systemInstruction = "{\"parts\":[{\"text\":\"You are DevBot (JARVIS), an advanced autonomous Jarvis-like Personal AI Assistant with real control over the user's Windows laptop, created by Dheena. "
                ...
                + "- [ACTION:close_app:<app>] Directly close, terminate, or turn off an application (e.g. whatsapp, telegram, instagram, chatgpt, vlc, anydesk, canva, filmora, word, excel, powerpoint, angry birds, beach buggy, solitaire, notepad, calc, chrome, edge, spotify, paint, code, cmd)!\\n"
                ...
                + "- [ACTION:open_app:<app>] Launch app (e.g. whatsapp, telegram, instagram, chatgpt, perplexity, vlc, anydesk, canva, filmora, word, excel, powerpoint, angry birds, beach buggy, solitaire, notepad, calc, paint, cmd, taskmgr, chrome, spotify, code)\\n"
